        ...
        for(int i = 0;i < 13;i++){ 
            ...
            for(int j = 0;j<29;j++){
                ...
                if(i%2!=0 && (j>0 && j<28)){ //condição de entrada nas partes sem grid
                    ...
                    if(j%4==0 && (j>0 && j<28) ) System.out.printf("."); //divisoria de 4 dentro do range 1 a 27 e não printar 2 coisas no msm espaço
                    
                    else if(i!=12 && (j>0 && j<28))System.out.print("-");
                    
                    else if(j>0 && j<28)System.out.print("=");
                }     
